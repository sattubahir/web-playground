# Satyajit Bahir | Full Stack Developer Profile (Single-File Source)
...
This profile highlights practical experience with the following technologies:

| Category | Technologies |
| :--- | :--- |
| **Backend / Core** | **Java**, **Hibernate**, JDBC, Servlets, JSP |
| **Database** | **MySQL**, Firebase Firestore |
| **Frontend** | HTML5, CSS3 (Responsive Design with Grid/Flexbox), JavaScript |
| **Data Science (Project)** | Python, Deep Learning, Flask |
